...
export default {
  ...
  mounted() {
    this.socket = new Socket({sessionStore: useSessionConfigStore(), networkStore: useNetworkConfigStore(), logStorage: useLogStore(), isDhcpServer: true});
    this.socket.connect()
  },
  beforeUnmount() {
...
<template>
  <div>
    <h1 class="text-primary-700 font-bold">DHCP</h1>
